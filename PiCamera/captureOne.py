...
#Just captures one image good for creating test images,
#easier to create a new script since rumCamera sometimes are used/modifed simuntainusly. 
...
def main():
    ...
    with requests.Session() as session:
        ...
        if True:
            for _ in camera.capture("/dev/shm/optiposimage.jpg", 'jpeg', use_video_port = True, quality = 10):
            try:
