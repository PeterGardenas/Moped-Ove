...
public class CanManager implements Runnable {
    ...
    CanManager(HashMap<String, Integer> senders, HashMap<Integer, String> receivers) {
        ...
        for (Entry<Integer, String> entry : receivers.entrySet()) {
            ...
            switch (function) {
                ...
                default:
                    System.out.println("Error: there is wrong function name for receivers");
                    System.exit(-1);
            }
        }
    ...
    public void sendMessage(Message message) {
        ...
        switch (message.getMessageType()) {
            ...
            case MessageType.UNINSTALL:
                System.out.println("[CanEcuManager - sendUninstallMessage(Message)]");
    ...
    private void sendMessage(LoadMessage message) {
        ...
        int totalSize = 1 + 1 + 4 + pluginNameSize + 4
        ...
        int i = javaCanLibrary.sendBigData(channelNumber, can_id, 8, byteArray.length,
                byteArray);
        System.out.println("Send can-install: " + i);
    }
